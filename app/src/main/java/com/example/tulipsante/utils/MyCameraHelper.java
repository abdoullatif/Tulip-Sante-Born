...
public class MyCameraHelper {
    ...
    private static MyCameraHelper mCameraHelper;
    // USB Manager
    ...
    private MyCameraHelper() {
    }

    public static MyCameraHelper getInstance() {
        if (mCameraHelper == null) {
            mCameraHelper = new MyCameraHelper();
        }
    ...
    public void initUSBMonitor(Activity activity, CameraViewInterface cameraView, final com.jiangdg.usbcamera.UVCCameraHelper.OnMyDevConnectListener listener) {
