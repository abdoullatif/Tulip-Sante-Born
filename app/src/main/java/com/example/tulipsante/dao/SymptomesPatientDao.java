...
public interface SymptomesPatientDao {
    ...
    @Query("SELECT symptome.type From symptome INNER JOIN symptomesPatient ON symptomesPatient.idSymptome LIKE symptome.idSymptome AND symptomesPatient.idConsultation LIKE :idConsultation")
