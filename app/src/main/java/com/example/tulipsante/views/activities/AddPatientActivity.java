...
public class AddPatientActivity extends AppCompatActivity implements DisableNfc, View.OnClickListener {
    ...
    public void showAlertDialogButtonClicked() {
        ...
        builder.setPositiveButton("Continue", (dialogInterface, i) -> {
            ...
            if(!uidPatient.equals("")) {
                if(!addPatientViewModel.checkUidExist(uidPatient)) {
                    ...
                    Toast.makeText(this, "Nfc tag already exist!", Toast.LENGTH_SHORT).show();
                }
            }
            else {
                Toast.makeText(this, "No RFID tag added!", Toast.LENGTH_SHORT).show();
                addPatientViewModel.insertNewPatient(
                        new Patient(
                                id,
                                surname,
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (NfcAdapter.ACTION_TAG_DISCOVERED.equals(intent.getAction())) {
            ...
            // get the uid patient
            assert tag != null;
            if(!addPatientViewModel.checkUidExist(GeneralPurposeFunctions.bytesToHexString(tag.getId()))) {
