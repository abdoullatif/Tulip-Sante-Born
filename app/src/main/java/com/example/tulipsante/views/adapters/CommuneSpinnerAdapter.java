...
public class CommuneSpinnerAdapter extends ArrayAdapter<Commune> {
    ...
    public CommuneSpinnerAdapter(@NonNull Context context, int resource, int textViewResourceId, List list) {
    ...
    private View rowView(View convertView, int postion) {
        Commune commune = getItem(postion);
        ...
        viewHolder.textViewSpinnerListItem.setText(commune.getNomCommune());
