...
public class UltrasoundModalDialogFragment extends BottomSheetDialogFragment {
    private CardView cancel;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_ultrasound_modal, container, false);
    }
