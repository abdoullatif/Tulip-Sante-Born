...
public class SymptomesListViewAdapter extends ArrayAdapter<Symptome> {
    ...
    private View rowView(View convertView, int postion) {
        Symptome symptome = getItem(postion);
        ...
        viewHolder.textViewSpinnerListItem.setText("(" + "d" + ") " +symptome.getDescription());
...
//        });
//        viewHolder.textViewEntry.setText(symptome.getDescription());
//
//        return rowView;
//    }
//
