...
public class RegionSpinnerAdapter extends ArrayAdapter<Region> {
    ...
    public RegionSpinnerAdapter(@NonNull Context context, int resource, int textViewResourceId, List list) {
    ...
    private View rowView(View convertView, int postion) {
        ...
        viewHolder.textViewSpinnerListItem.setText(region.getNomRegion());
