...
public class DiagnosticFragment extends Fragment {
    ...
    private void initViews(View view) {
        ...
        medSpinner = view.findViewById(R.id.patologySpinner);
    }
    ...
    private void initialisation() {
        ...
        medSpinner.setTitle("Select Pathology");
    ...
    private void setPatologySpinner() {
        ...
        medSpinner.setAdapter(diagnosticSpinnerAdapter);
        medSpinner.setOnSearchTextChangedListener(strText -> {
            // non search list changed
        });
