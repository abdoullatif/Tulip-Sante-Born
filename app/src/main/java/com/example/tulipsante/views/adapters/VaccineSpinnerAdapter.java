...
public class VaccineSpinnerAdapter extends ArrayAdapter<TypeVaccination> {
    LayoutInflater flater;

    public VaccineSpinnerAdapter(@NonNull Context context, int resource, int textViewResourceId, List list) {
    ...
    private View rowView(View convertView, int postion) {
        TypeVaccination typeVaccination = getItem(postion);
        ...
        viewHolder.textViewSpinnerListItem.setText(typeVaccination.getType());
