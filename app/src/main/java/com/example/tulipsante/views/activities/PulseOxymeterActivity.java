...
import com.guide.guidecore.prase.UsbBuffer;
            ...
            public void onReceiveData(byte[] dat, int paramInt) {
               ...
               // System.out.println(Arrays.toString(dat));
                runOnUiThread(() -> {
                   ...
                   // Toast.makeText(PulseOxymeterActivity.this,"data size "+data.size(), Toast.LENGTH_SHORT).show();
