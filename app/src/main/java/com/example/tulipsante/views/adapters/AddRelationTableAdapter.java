...
public class AddRelationTableAdapter extends RecyclerView.Adapter<AddRelationTableAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        if(!patients.get(position).getIdPatient().equals(idPatient)) {
            holder.textViewProfession.setText(patients.get(position).getIdPatient());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            textViewFull = itemView.findViewById(R.id.textViewLast);
            textViewProfession = itemView.findViewById(R.id.textViewFirst);
