...
public class AllRecViewAdapter extends RecyclerView.Adapter<AllRecViewAdapter.ViewHolder> {
    private List<Allergie> allergieList = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.textViewValue.setText(allergieList.get(position).getDescription());
