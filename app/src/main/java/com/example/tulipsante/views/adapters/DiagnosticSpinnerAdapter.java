...
public class DiagnosticSpinnerAdapter extends ArrayAdapter<Maladie> {

    LayoutInflater flater;

    public DiagnosticSpinnerAdapter(@NonNull Context context, int resource, int textViewResourceId, List list) {
    ...
    private View rowView(View convertView, int postion) {
        ...
        viewHolder.textViewSpinnerListItem.setText("(" +maladie.getType() + ") " +maladie.getDescription());
