...
//    }
    ...
    public List<Symptome> getAllSymptomes() {
        List<Symptome> symptomes = null;
        try {
            symptomes = new GetSymptomesAsyncTask(symptomeDao).execute().get();
        } catch (Exception ignored){}
        return symptomes;
    }
    ...
    private static class GetSymptomesAsyncTask extends AsyncTask<String, Void, List<Symptome>> {
        private SymptomeDao symptomeDao;
        private GetSymptomesAsyncTask(SymptomeDao symptomeDao) {
            this.symptomeDao = symptomeDao;
        }
        @Override
        protected List<Symptome> doInBackground(String... data) {
            return symptomeDao.getSymptomes();
        }
    }
