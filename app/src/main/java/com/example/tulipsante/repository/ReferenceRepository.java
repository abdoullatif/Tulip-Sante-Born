...
public class ReferenceRepository {
    ...
    public LiveData<List<PatientXRefXDoc>> patientReferredByOthers(List<String> data) {
        LiveData<List<PatientXRefXDoc>> patientList = null;
        patientList = referenceDao.patientReferredByOthers(data.get(0), data.get(1));
        return patientList;
    }

    public LiveData<List<PatientXRefXDoc>> patientReferredByMe(List<String> data) {
        LiveData<List<PatientXRefXDoc>> patientList = null;
        patientList = referenceDao.patientReferredByMe(data.get(0), data.get(1));
        return patientList;
    }
}
